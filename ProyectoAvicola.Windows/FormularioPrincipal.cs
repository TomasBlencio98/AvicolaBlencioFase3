...
namespace ProyectoAvicola.Windows
{
    public partial class FormularioPrincipal : Form
    {
        ...
        private void editarToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Debe listar", "Mensaje",
                        MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
        ...
        private void listarGalpones()
        {
            GalponesButtonEnabel();
            string[] columnas = typeof(GalponDto).GetProperties().Select(p => { var displayNameAttribute = (DisplayNameAttribute)Attribute.GetCustomAttribute(p, typeof(DisplayNameAttribute)); return displayNameAttribute != null ? displayNameAttribute.DisplayName : p.Name; }).ToArray();
            GridHelpers.CargarGrilla<GalponDto>(DgvDatos, columnas);
            RefrescarGrillaGalpones();
        }

        private void RefrescarGrillaGalpones()
        {
            listaGalpones = servicioGalpones.GetGalpones();
            GridHelpers.MostrarDatosEnGrilla(DgvDatos, listaGalpones);
        }

        private void GalponesButtonEnabel()
        {
            DropDownButtonGranja.Enabled = false;
            DropDownButtonEmpleados.Enabled = false;
            DropDownButtonProveedores.Enabled = false;
